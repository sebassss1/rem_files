...
public class Configuration
{
    ...
    // External Service Integration (Microservices)
    public string ExternalAuthServiceUrl = "";
    public string ExternalDatabaseServiceUrl = "";
    public string ExternalAnalyticsServiceUrl = "";
    /// <summary>
